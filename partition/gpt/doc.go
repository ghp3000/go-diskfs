...
//
// gpt.Table implements the Table interface in github.com/ghp3000/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/ghp3000/go-diskfs package,
